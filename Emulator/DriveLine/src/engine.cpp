...
void Engine::GearCalc(const uint8_t& throtle, 
                        const uint8_t& user_gear,
                         const uint8_t& ignition){
...
void Engine::Rpm(const uint8_t& throtle, const uint8_t& gear){
    rpm_ = throtle * 3/ gear;
}
void Engine::Speed(const uint8_t& rpm, const uint8_t& gear){
    speed_ = rpm /gear;
 }
uint8_t Engine::getRpm()const{
    return rpm_;
}
uint8_t Engine::getSpeed()const{
    return speed_;
}
uint8_t Engine::getGear()const{
    return gear_;
}
